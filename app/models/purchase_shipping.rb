class PurchaseShipping
  ...
  attr_accessor :zip_code, :prefecture_id, :municipal_district, :address, :building_name, :telephone_number, :purchase_id,
  ...
  def save
    ...
    Shipping.create(zip_code: zip_code, prefecture: prefecture_id, municipal_district: municipal_district, address: address,
